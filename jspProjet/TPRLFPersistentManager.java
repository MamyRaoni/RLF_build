...
public class TPRLFPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TPRLF";
	...
	private TPRLFPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Utilisateur.class);
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Projet.class);
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Message.class);
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Paiement.class);
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Verification_Identite.class);
		aMetadataSources.addAnnotatedClass(diagramme_des_classes.Don.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TPRLFPersistentManager();
		}
